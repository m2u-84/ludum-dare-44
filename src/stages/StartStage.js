...
StartStage.prototype.preload = function() {
  ...
  this.menuButton = new Button(this.menuButtonImage, menuButton1frames, () => stageManager.crossfadeToStage("levelSelect", 800, 0), this, this.startingSound, this.hoverSound, false, true);
