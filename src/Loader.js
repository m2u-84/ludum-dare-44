...
const ASSET_IMAGES_BASE_PATH = ASSETS_BASE_PATH + 'images/';
const ASSET_AUDIOS_BASE_PATH = ASSETS_BASE_PATH + 'audio/';
...
Loader.prototype.loadAssetImage = function(assetPath, frameCountX, frameCountY) {
    return this.loadImage(ASSET_IMAGES_BASE_PATH + assetPath, frameCountX, frameCountY);
};
...
Loader.prototype.loadAssetAudio = function(assetData) {
    assetData.src = ASSET_AUDIOS_BASE_PATH + assetData.src;

    return this.loadAudio(assetData);
};
