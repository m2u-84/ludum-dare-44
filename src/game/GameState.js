function GameState(currentLevel) {
    ...
    this.treatments = {
        ...
        placeboSurgery: new Treatment('Placebo Surgery',    10,      600,   80,  0.0,  0.0, 0.0 , undefined, 1),
        surgery:        new Treatment('Surgery',            20,     1000,  500, -0.1, -0.3, 0.1 , undefined, 2),
        organ:          new Treatment('Give Organ',         30,     5000, 1000, -0.1, -0.3, 0.12, () => this.hospital.organs > 0, 2),
        antibiotics:    new Treatment('Give Antibiotics',    5,      200,   40, -0.1, -0.1, 0.0 , undefined, 3),
